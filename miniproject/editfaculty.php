...
if(isset($_GET['fid']))
{
    ...
    if(isset($_POST['submit']))
    {
        ...
        $sql=" UPDATE faculty SET fname='$fname',email='$email',position='$position',department='$department' WHERE fid='$fid'";
...
<html>
  ...
  <body>
     <section class="container">
        <header>Faculty form</header>
        <form action="" method="post" class="form">
            <div class="column">
                <div class="input-box">
                    <label></label>
                    <input type="text" placeholder="name" name="fname" value="<?php echo $row['fname'];?>" required>
                </div>
    ...
    <div class="column">
        <div class="select-box">
            <select name="position" value="<?php echo $row['position'];?>" required>
